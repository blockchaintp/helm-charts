...
| `apiserver.imageTag`                    | Image Tag for API Server                      | `2.0.0`                                  |
...
| `provisioner.imageTag`                  | Image Tag for Provisioner                     | `2.0.0`                                  |
...
| `localprovisioner.imageTag`             | Image Tag for localProvisioner                | `2.0.0`                                  |
...
| `webhook.imageTag`                      | Image Tag for admission server                | `2.0.0`                                  |
...
| `ndmOperator.imageTag`                  | Image Tag for NDM Operator                    | `0.8.0`                                   |
| `jiva.image`                            | Image for Jiva                                | `openebs/jiva`                            |
| `jiva.imageTag`                         | Image Tag for Jiva                            | `2.0.0`                                  |
...
| `cstor.pool.imageTag`                   | Image Tag for cStor Pool                      | `2.0.0`                                  |
| `cstor.poolMgmt.image`                  | Image for cStor Pool  Management              | `openebs/cstor-pool-mgmt`                 |
| `cstor.poolMgmt.imageTag`               | Image Tag for cStor Pool Management           | `2.0.0`                                  |
| `cstor.target.image`                    | Image for cStor Target                        | `openebs/cstor-istgt`                     |
| `cstor.target.imageTag`                 | Image Tag for cStor Target                    | `2.0.0`                                  |
| `cstor.volumeMgmt.image`                | Image for cStor Volume  Management            | `openebs/cstor-volume-mgmt`               |
| `cstor.volumeMgmt.imageTag`             | Image Tag for cStor Volume Management         | `2.0.0`                                  |
| `helper.image`                          | Image for helper                              | `openebs/linux-utils`                     |
| `helper.imageTag`                       | Image Tag for helper                          | `2.0.0`                                  |
...
| `policies.monitoring.imageTag`          | Image Tag for Prometheus Exporter             | `2.0.0`                                  |
